...
public class InformationDialog {
    ...
    public static final Key DIALOG_KEY = Key.key(Deceiv.PLUGIN_ID, InformationDialog.DIALOG_ID);
    ...
    public PrioritizedLifecycleEventHandlerConfiguration<BootstrapContext> get() {
        return RegistryEvents.DIALOG.compose().newHandler(event -> event.registry().register(
                DialogKeys.create(Key.key(Deceiv.PLUGIN_ID, InformationDialog.DIALOG_ID)), builder -> builder
